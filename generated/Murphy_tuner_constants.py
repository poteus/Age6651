...
class TunerConstants:
    ...
    _steer_initial_configs = configs.TalonFXConfiguration().with_current_limits(
        ...
        # SUPPLY LIMIT: Prevents brownouts. 
        # We limit the "draw" from the battery. 40A is a safe, standard FRC limit.
    ...
    _front_right_encoder_offset: units.rotation = -0.004150390625
    ...
    _back_left_encoder_offset: units.rotation = 0.231689453125
    ...
    _back_right_encoder_offset: units.rotation = -0.0771484375
