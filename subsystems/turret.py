...
class Turret(commands2.Subsystem):
    ...
    positions = {
        "Blue": {
            "top_corner": Pose2d(0.0, 8.05, 0.0),
            "bottom_corner": Pose2d(0.0, 0.0, 0.0),
            "hub": Pose2d(0.0, 5.5, 0.0)
        },
        "Red": {
            "top_corner": Pose2d(16.55, 8.05, 0.0),
            "bottom_corner": Pose2d(16.55, 0.0, 0.0),
            "hub": Pose2d(0.0, 5.5, 0.0)
        },
    }
