...
class Shooter(commands2.Subsystem):
    ...
    def __init__(self, _telemetry:Telemetry):
        ...
        # Hood PID values
        hood_cfg.slot0.k_s = 0.25
        hood_cfg.slot0.k_v = 0.12  
        hood_cfg.slot0.k_a = 0.01
        hood_cfg.slot0.k_p = 50
        hood_cfg.slot0.k_i = 0.0
        hood_cfg.slot0.k_d = 2

        # Soft Limits
        hood_cfg.software_limit_switch.forward_soft_limit_threshold = self.upper_limit
        hood_cfg.software_limit_switch.forward_soft_limit_enable = True
        hood_cfg.software_limit_switch.reverse_soft_limit_threshold = self.lower_limit
        hood_cfg.software_limit_switch.reverse_soft_limit_enable = True
        
        # Motion Magic Settings
        hood_cfg.motion_magic.motion_magic_cruise_velocity = 1.5 
        hood_cfg.motion_magic.motion_magic_acceleration = 3
        hood_cfg.motion_magic.motion_magic_jerk = 30.0
        hood_cfg.motion_magic.motion_magic_expo_k_v = 0.0 # Volts per RPS
        hood_cfg.motion_magic.motion_magic_expo_k_a = 0.0 # Volts
    ...
    def set_hood_position(self, rotations: float):
        """Sets hood position using Motion Magic Voltage."""
        self.hood.set_control(self.hood_position_request.with_position(rotations))
